...
LangString K10_FINISH_RUN      ${LANG_HEBREW} "Launch K10 Web Protection"
LangString K10_MSG_STOPPING    ${LANG_HEBREW} "Stopping existing instance..."
LangString K10_MSG_COPYING     ${LANG_HEBREW} "Copying files..."
LangString K10_MSG_SHORTCUTS   ${LANG_HEBREW} "Creating shortcuts..."
LangString K10_MSG_SYSINT      ${LANG_HEBREW} "Configuring system integration..."
LangString K10_MSG_SYSINT_WARN ${LANG_HEBREW} "Warning: system integration step returned $0"
LangString K10_MSG_WATCHDOG    ${LANG_HEBREW} "Starting watchdog..."
LangString K10_MSG_UN_CLEANUP  ${LANG_HEBREW} "Cleaning up system integration..."
LangString K10_MSG_UN_REMOVING ${LANG_HEBREW} "Removing files..."
